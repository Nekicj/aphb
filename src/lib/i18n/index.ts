export const enHome = {
    ...
    "about.competition.description":
        "APhB combines a unique format of team competitions for school students in solving physics Olympiad problems. The entire tournament is organized exclusively by high school seniors or college freshmen.",
    "about.competition.fights":
        "Physics Battles to this point have been held only in Russia, Ukraine, and France, while they have not been conducted at all in the rest of the world. Our tournament is the first in Kazakhstan and Central Asia",
    ...
    "teamwork.description":
        "The format entails mandatory collaborative and effective work of all team members to win. It is primarily the ability to maintain a friendly atmosphere after 6-hour marathons of solving the most complex Olympiad physics problems and sensible allocation of duties",
    strategy: "STRATEGY",
...
export const ruHome = {
    ...
    "about.competition.fights":
        "Физические бои по сей проводились только в России, Украине и Франции, когда как в остальном мире они вовсе не проводятся. Наш турнир - первый в Казахстане и Центральной Азии",
    ...
    "teamwork.description":
        "Формат предусматривает обязательную совместную и эффективную работу всех членов команды для победы. Это прежде всего способность поддерживать дружескую обстановку после 6-ти часовых марафонов решения сложнейших задач по олимпиадной физике и грамотное распределение обязанностей",
    strategy: "СТРАТЕГИЯ",
    "strategy.description":
        "Для победы команды должны выстраивать грамотную тактику и стратегии. Только с ними можно обыграть более академически сильную команду",
...
export const kzHome = {
    ...
    "about.competition.description":
        "АРhВ физикадан олимпиадалық тапсырмаларды шешуде оқушылардың командалық жарыстарының бірегей форматын үйлестіреді. Турнирді жоғары сынып оқушылары немесе бірінші курс студенттері ұйымдастырады.", "about.competition.fights":
        "Физикалық жекпе-жек қазіргі уақытқа дейін тек Ресей, Украина және Францияда өткізілді, ал әлемнің қалған бөлігінде мүлдем өткізілмеді. Біздің турнир - Қазақстан мен Орталық Азиядағы алғашқы турнир", "league.older": "Үлкен лига",
    ...
    "teamwork.description":
        "Формат жеңіске жету үшін міндетті түрде команданың барлық мүшелерінің бірлескен және тиімді жұмысын көздейді. Бұл ең алдымен 6 сағат олимпиадалық физика бойынша күрделі есептерді шешкеннен кейін достық атмосфераны сақтау және міндеттерді орындауда дұрыс бөлу қабілеті", strategy: "СТРАТЕГИЯ",
    "strategy.description":
    ...
    "learn.compete.win": "ҮЙРЕН. БӘСЕКЕЛЕС. ЖЕҢІСКЕ ЖЕТ.",
    "learn.compete.win.quote":
        "«Математик кез келген ойын айта алады, бірақ физик кем дегенде аздап сауатты ойды сақтауы керек.»",
    "learn.compete.win.quote.author": "Д. Гиббс",
    "learn.compete.win.description":
